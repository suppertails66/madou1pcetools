...
typedef std::map<int, int> AddrToOpMap;
...
const int tableBase = 0x081C;
const int numOps = 0x33;
...
//    ifs.open("files_sat/1ST_MAHO.BIN");
    ifs.open("base/dungeon_12B1_16000.bin");
    ifs.seek(tableBase);
...
//    ifs.writeString(line);
    ...
    int addr = TStringConversion::stringToInt(numstr);
